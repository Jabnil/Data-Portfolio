...
# 1. Load the raw data
df = pd.read_csv('/workspaces/Data-Portfolio/Project-01-Sales-Analysis/notebooks/data/raw/raw_ecommerce_sales.csv')
...
df.to_csv('/workspaces/Data-Portfolio/Project-01-Sales-Analysis/notebooks/data/processed/cleaned_sales_data.csv', index=False)
